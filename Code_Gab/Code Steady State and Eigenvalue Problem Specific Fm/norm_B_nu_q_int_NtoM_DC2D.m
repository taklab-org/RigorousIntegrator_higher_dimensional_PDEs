function [norm_B] = norm_B_nu_q_int_NtoM_DC2D(B,nu1,nu2,q1,q2,N_Fm,N_Fm_ext)

N_lin_numel = sum(N_Fm+1);
N_col_numel = sum(N_Fm_ext+1);
[N1,N2] = omega12_DC2D(N_Fm,N_Fm_ext,nu1,q1);
...
for i = 1:i_ind
    ...
    Norm_colum(i) = norm_1_nu_q_int(B_temp,nu2,q2)./(omega_k(i));
end
