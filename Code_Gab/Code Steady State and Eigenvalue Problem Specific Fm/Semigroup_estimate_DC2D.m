function [C,lambda] = Semigroup_estimate_DC2D(a,mu_inf,nu,q,mu_k,Nop_coeff,P,N_Fm,N_Fm_ext,p_r,DF11,N12,N21)
...
% delta constant
E11 = norm_B_nu_q_int(A_nodiag,nu,Na,q,N_Fm) + p_r*C1*C2;

D12 = P_inv*N12;
D21 = N21*P;

E12 = norm_B_nu_q_int_NtoM(D12,nu,q,N_Fm,N_Fm_ext) + p_r*C2;
E21 = norm_B_nu_q_int_NtoM(D21,nu,q,N_Fm_ext,N_Fm) + p_r*C1;
...
E33 = 3*norm_1_nu_q_int(a2,nu,q) + p_r;
